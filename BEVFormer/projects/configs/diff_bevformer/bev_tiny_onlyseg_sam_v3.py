...
unet = dict(
    type='projects.bevdiffuser.layout_diffusion.seg_diffusion_unet_v3.DiffusionUNetModel',
    parameters=dict(
        image_size=bev_h_,
        use_fp16=False,
...
model = dict(
    ...
    mgd_lambda=0.6,  # paper detection 권장값
    use_grid_mask=True,
...
evaluation = dict(interval=1000, dynamic_intervals=[(12, 6)], pipeline=test_pipeline)
