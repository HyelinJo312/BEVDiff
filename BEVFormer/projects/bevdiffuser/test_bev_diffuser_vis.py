...
def test():
    ...
    save_path = os.path.join('../../../results', args.checkpoint_dir.split('/')[-2], args.checkpoint_dir.split('/')[-1])       
...
def evaluate(unet,
    ...
    for step, batch in enumerate(dataloader):
        ...
        ## -------------------- Channel-Avg Grayscale (paper Figure 1 style) -------------------- ##

        # render_bev_channel_avg_triplet(
        #     original_bev, denoised_bev, b=0,
        #     nusc=nusc, sample_token=sample_token,
        #     out_dir=f"{save_path}/visualize/channel_avg_v2",
        #     title=f"step {step} | BEV feature (channel avg)",
        ...
        render_bev_triplet(
            original_bev, denoised_bev, b=0,
            nusc=nusc, sample_token=sample_token,
            out_dir=f"{save_path}/visualize/activation_map",
