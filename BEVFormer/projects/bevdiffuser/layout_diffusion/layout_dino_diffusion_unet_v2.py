...
class LayoutDiffusionUNetModel(nn.Module):
    ...
    def __init__(
        ...
        # self.multi_concat = MultiScaleConcatFusion(in_chs=(model_channels, model_channels*2, model_channels*4, model_channels*4), 
        #                                     out_dim=out_channels, 
        #                                     mid=model_channels, T=1.0, beta=2.0)
        # self.multi_concat = MultiScaleConcat(in_chs=(model_channels, model_channels*2, model_channels*4, model_channels*4), 
        #                                     out_dim=out_channels, 
        #                                     mid=model_channels)
        # self.multi_concat = MultiScaleConcatV2(in_chs=(model_channels, model_channels*2, model_channels*4, model_channels*4),
        #                                        out_dim=out_channels, 
        #                                        mid=model_channels)
        # self.multi_concat = MultiScaleConcatV3(in_chs=(model_channels, model_channels*2, model_channels*4, model_channels*4),
        #                                        out_dim=out_channels, 
        #                                        mid=model_channels)
