...
Layout에서 obj_class 제외 

+) 
    1. G-SAM text prompt -> CLIP embedding 활용
    or
    2. obj_name 사용 (segmentation 전용 class 포함)
...
class LayoutDiffusionUNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, img_metas, seg_cond, obj_class=None, obj_bbox=None, obj_mask=None, is_valid_obj=None, obj_name=None, depth_maps=None, **kwargs):
        ...
        seg_bev_maps, seg_bev_prob = self.seg_aligner(seg_cond, img_metas, depth_maps=depth_maps) # (B, C, H, W)
