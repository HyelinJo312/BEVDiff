...
BEV_CONFIG="../configs/bevdiffuser/layout_base_seg_v4.py"
BEV_CHECKPOINT="../../ckpts/bevformer_r101_dcn_24ep.pth"
PRETRAINED_MODEL="stabilityai/stable-diffusion-2-1"
PRETRAINED_UNET_CHECKPOINT="../../../results/version2/stage1/BEVDiffuser_tiny_seg_one-hot_v11/checkpoint-50000"

# set up wandb project
PROJ_NAME=BEVDiffuser
RUN_NAME=BEVDiffuser_base_seg_one-hot_v11
# checkpoint settings
