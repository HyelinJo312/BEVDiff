...
class DiffBEVFormerDINOGT(BEVFormer):
    ...
    def forward_pts_train(self,
        ...
        if bev_diffuser:
            ...
            bev_ = bev_diffuser(bev_, img, img_metas, get_condition(), grad_fn=None)   # 현재 grad_fn 사용 안함 (use_classifier_guidence=False)
