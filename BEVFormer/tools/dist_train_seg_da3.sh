...
CONFIG="./projects/configs/diff_bevformer/layout_tiny_seg_v4_da3_v2.py"
UNET_CHECKPOINT_DIR="../results/version2/stage1/BEVDiffuser_tiny_seg_one-hot_v12/checkpoint-50000"
LOAD_FROM="./ckpts/bevformer_tiny_epoch_24.pth"
RESUME_FROM="None"
RUN_NAME="DiffBEVFormer_tiny_seg_da3_v5"
