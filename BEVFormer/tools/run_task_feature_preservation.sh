#!/usr/bin/env bash
# Run task feature preservation analysis: trained deployed student BEV vs S0.
...
OUTPUT_DIR=${OUTPUT_DIR:-../results/feature_alignment/task_feature_preservation_200_frames}
...
"${PYTHON}" tools/analysis_tools/analyze_task_feature_preservation.py \
